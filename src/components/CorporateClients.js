  ...
  return (
    <>
      <div className="lg:h-screen h-full">
        ...
        <div className="md:flex md:flex-row md:gap-0  md:justify-around md:mx-16 lg:gap-16 lg:justify-center md:mt-16 font-display">
          <div className="flex flex-col -mt-101 mx-10 gap-7 lg:-mt-50 md:-mt-104 md:max-w-md lg:max-w-lg">
            ...
            <ul>
              <li className="text-xl pb-2">
                ...
                налоговые споры, тарифное регулирование
              </li>
              <li className="text-xl pb-2">
                <svg
                  className="w-6 h-6 inline-block mr-2"
                ...
                споры с контрольно-надзорными органами
              </li>
              <li className="text-xl pb-2">
                <svg
                  className="w-6 h-6 inline-block mr-2"
                ...
                споры с органами власти и органами местного самоуправления, не
                связанными с контрольно-надзорной деятельностью
              </li>
              <li className="text-xl pb-2">
                <svg
                  className="w-6 h-6 inline-block mr-2"
                ...
                представление интересов в банкротстве (должника, кредитора,
          ...
          <div className="card md:max-h-4 md:max-w-xs lg:max-h-5 lg:max-w-sm  lg:-mt-98 md:-mt-100 mx-10">
            <ul>
              <li className="text-xl pb-2">
                ...
                хозяйственные (включая госзакупки), корпоративные споры
              </li>
              <li className="text-xl pb-2">
                <svg
                  className="w-6 h-6 inline-block mr-2"
                ...
                разработка внутренних документов организаций
              </li>
              <li className="text-xl pb-2">
                <svg
                  className="w-6 h-6 inline-block mr-2"
              ...
              <li className="text-xl pb-2">
                ...
                регистрация, ликвидация организаций
              </li>
            </ul>
            <button
              type="button"
              className="md:hidden block my-6 bg-gradient-to-r from-Pink to-Purple text-white hover:from-green-500 hover:to-blue-400 transform hover:scale-110 transition-all  hover:bg-white  private-clients  text-xl font-light h-12 bg-lightWhite md:w-48 px-4  lg:text-2xl lg:w-64 rounded-sm"
            >
